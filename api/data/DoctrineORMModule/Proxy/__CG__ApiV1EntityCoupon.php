 ...
 */
class Coupon extends \Api\V1\Entity\Coupon implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'code', 'currentUsages', 'isActive', 'name', 'maxRedemption', 'redemptionStartDate', 'redemptionEndDate', 'subscriptionLength', 'price', 'codeString', 'plan', 'deleted', 'created', 'modified', 'subscriptions');
    }
